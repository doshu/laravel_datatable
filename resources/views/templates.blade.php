...
<template id="datatable-template">
    <div class="datatable" :class="{'datatable-responsive': isMobile}">
                        ...
                        <div class="left-actions">
                            ...
                            <div class="selection-actions" v-if="hasMassiveActions">
                                ...
                                <small class="count-checked-rows" v-if="rowsChecked.length">
                                    <?= __('Selezionato :length di :count', ['length' => '{{ rowsChecked.length }}', 'count' => '{{ pagination.count }}']) ?>
                                </small>
                            </div>
                        </div>
        ...
        <div class="paginator" v-if="pagination">
            ...
            <p><?= __(':page di :count, :total elementi totali', ['page' => '{{ pagination.page }}', 'count' => '{{ pagination.pageCount }}', 'total' => '{{ pagination.count }}']) ?></p>
        </div>
...
@push('script')
    <script src="{{ asset('vendor/datatable/js/components.js') }}"></script>
@endpush
